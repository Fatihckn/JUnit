...
import com.junitdemo.integration.junit.security.SecurityConstants;
...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // Her test için ayrı nesne oluşturulmaz.
public class UsersControllerIntegrationTest {

    @Value("${server.port}")
    private int serverPort;

    // Sunucunun çalıştığı portu almamızı sağlar
    @LocalServerPort
